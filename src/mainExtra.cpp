...
int main(int argc, char *argv[]) {
    int n[7] = {100000,200000,400000,800000,1600000,3000000,3173647};
    ...
    for (int i = 0; i < 6; ++i){
        ...
        timeCont[i] /= 20.0;
        timeAggr[i] /= 20.0;
        cout << "\tTiempo countRegion (Resultado = "<< c<< "): " << timeCont[i]/1e9 << " s." << endl;
        cout << "\tTiempo aggregateRegion (Resultado = "<< a<< "): " << timeAggr[i]/1e9 << " s.\n" << endl;
    }
